"""
Auto Spotify Playlist Scraper - Keyboard Navigation Version
使用鍵盤導航來抓取 Spotify 歌單
"""
...
async def auto_scrape(playlist_url: str) -> dict:
    """Scrape Spotify playlist using keyboard navigation"""
...
if __name__ == '__main__':
    ...
    result = asyncio.run(auto_scrape(url))
